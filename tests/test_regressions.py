...
class RegressionReconcileTests(unittest.TestCase):
    ...
    def test_balance_reason_analysis_groups_complex_pdf_case(self):
        ...
        display_ops = self.main._balance_reason_operations_for_display([reasons[bn_title]])
        self.assertEqual(len(display_ops), 2)
        self.assertAlmostEqual(sum(op['influence'] for op in display_ops), 2821717.86, places=2)
